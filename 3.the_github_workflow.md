...
1. Create a change label (aka create a branch)
2. Make the changes you want
3. Store changes and a new version of the directory
4. Publish and backup your changes to github
5. Create change proposal (aka create a pull request)
6. Review change proposal
7. Approve or reject a change proposal
...
Make sure you the right label (aka branch) is selected.
Then click the "publish" button in the top left of the screen.


*****

## Create change proposal (aka a pull request)
